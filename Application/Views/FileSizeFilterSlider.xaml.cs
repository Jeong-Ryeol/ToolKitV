...
{
    public partial class FileSizeFilterSlider : UserControl, INotifyPropertyChanged
    {
        ...
        private readonly string[] _values = { "0", "8", "16", "24", "32", "64" };

        public string NumberValue { get; set; } = "16";
        public string Value
        {
            get => NumberValue;
            set
